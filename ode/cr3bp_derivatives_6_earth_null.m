function out = cr3bp_derivatives_6_earth_null(t,y,mu)
...
xout(1) = (mu*(2*mu + 2*x - 2))/(2*((mu + x - 1)^2 + y^2 + z^2)^(3/2))  - x;
xout(2) = (mu*y)/((mu + x - 1)^2 + y^2 + z^2)^(3/2) - y;
xout(3) = (mu*z)/((mu + x - 1)^2 + y^2 + z^2)^(3/2);
end
