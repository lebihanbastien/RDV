function [t,Xtilde] = orbit_postprocess_modified(cr3bp, orbit_target,orbit_chaser, params, cst)
...
if(params.computation.type == cst.computation.MATLAB)
    ...
    % initial states
    y0(1:6) = orbit_target.yv(1,1:6);
    y0(7:12) = orbit_chaser.yv(1,1:6);
    y0(13:18) = (orbit_chaser.yv(1,1:6)-orbit_target.yv(1,1:6));
    
    % resolution
    nombre_minutes = 5;
    step = nombre_minutes*60/(cr3bp.T/(2*pi));
    TSPAN = 0:step:tf;
    [t,Xtilde] = ode113(@(t,y)cr3bp_relative_18(t,y,cr3bp),TSPAN, y0, options);
