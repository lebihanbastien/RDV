...
output.C       = getfield(output.orbit,'C');
output.T       = getfield(output.orbit,'T');
output.Az      = getfield(output.orbit,'Az');
output.Azdim   = getfield(output.orbit,'Azdim');
output.perigee = getfield(output.orbit,'perigee');
output.altitudeOfPerigee = getfield(output.perigee,'altitude');
output.perigeeDistanceToMoonCenter = getfield(output.perigee,'radius');
